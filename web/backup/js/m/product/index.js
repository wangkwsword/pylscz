                ...
                $.ajax({
                    ...
                    success:function( res ){
                        ...
                        for( idx in res.data.data ){
                            ...
                            html += '<li> <a href="' + common_ops.buildMUrl( "/product/info",{ id:info['id'] } ) + '"> <i><img src="'+ info['main_image_url'] +'"  style="width: 100%;height: 200px;"/></i> <span>'+ info['name'] +'</span> <b><label>月出行' + info['month_count'] +'</label>¥' + info['price'] +'</b> </a> </li>';
                        }
