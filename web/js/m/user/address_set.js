...
var user_address_set_ops = {
    ...
    province_cascade:function(){
        ...
        $("#city_id").html("");
        $("#city_id").append("<option value='0'>请选择区域</option>");
    ...
    city_cascade:function(){
        ...
        $("#area_id").html("");
        $("#area_id").append("<option value='0'>请选择大体位置</option>");
