...
class MAsset extends AssetBundle
{
	...
	public function registerAssetFiles( $view ){
		...
		$this->css = [
            UrlService::buildWwwUrl( "/css/m/mui.picker.min.css"),
		...
		if( UtilService::isWechat() ){
			$this->js = [
				...
				UrlService::buildWwwUrl( "/plugins/mui.min.js"),
                UrlService::buildWwwUrl( "/plugins/mui.picker.min.js"),
                UrlService::buildWwwUrl( "/plugins/jquery-2.1.1.js"),
                UrlService::buildWwwUrl( "/js/m/moremui.js"),
