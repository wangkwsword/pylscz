...
<div class="row m-t  wrap_brand_set">
	<div class="col-lg-12">
		<h2 class="text-center">公司设置</h2>
		<div class="form-horizontal m-t m-b">
			<div class="form-group">
				<label class="col-lg-2 control-label">公司名称:</label>
				<div class="col-lg-10">
					<input type="text" name="name" class="form-control" placeholder="请输入公司名称~~" value="<?=$info?$info['name']:'';?>">
				</div>
			</div>
			...
			<div class="hr-line-dashed"></div>
			<div class="form-group">
				<label class="col-lg-2 control-label">公司介绍:</label>
				<div class="col-lg-10">
