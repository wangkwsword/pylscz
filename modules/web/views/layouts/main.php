	...
	<nav class="navbar-default navbar-static-side" role="navigation">
		<div class="sidebar-collapse">
			<ul class="nav metismenu" id="side-menu">
                ...
                <li class="brand">
                    <a href="<?=UrlService::buildWebUrl("/brand/info");?>"><i class="fa fa-cog fa-lg"></i> <span class="nav-label">公司设置</span></a>
                </li>
                <li class="book">
                    <a href="<?=UrlService::buildWebUrl("/book/index");?>"><i class="fa fa-book fa-lg"></i> <span class="nav-label">线路管理</span></a>
                </li>
                <li class="member">
