...
<div class="fastway_list_box">
    <ul class="fastway_list">
        <li><a href="<?=UrlService::buildNullUrl();?>" style="padding-left: 0.1rem;"><span>公司名称：<?=UtilService::encode( $info['name'] );?></span></a></li>
        ...
        <li><a href="<?=UrlService::buildNullUrl();?>" style="padding-left: 0.1rem;"><span>公司介绍：<?=UtilService::encode( $info['description'] );?></span></a></li>
    </ul>
</div>