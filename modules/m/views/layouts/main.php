...
<div class="copyright clearfix">
	...
	<?php endif;?>
    <p class="copyright">由<a href="<?=UrlService::buildWwwUrl('/');?>" target="_blank">山东交运集团平阴公司</a>提供技术支持</p>
</div>
...
<div class="footer_fixed clearfix">
	...
	<span><a href="<?=UrlService::buildMUrl("/product/index");?>" class="product"><i class="store_icon"></i><b>线路</b></a></span>
