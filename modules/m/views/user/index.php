...
<!--		<li><a href="--><?//=UrlService::buildMUrl("/product/cart");?><!--"><b class="wl_icon"></b><i class="right_icon"></i><span>出行计划</span></a></li>-->
		<li><a href="<?=UrlService::buildMUrl("/user/order");?>"><b class="morder_icon"></b><i class="right_icon"></i><span>出行记录</span></a></li>
		...
		<li><a href="<?=UrlService::buildMUrl("/user/address");?>"><b class="locate_icon"></b><i class="right_icon"></i><span>我的地址</span></a></li>
	</ul>
</div>
<div class="footer_fixed clearfix">
    <span><a href="<?=UrlService::buildMUrl("/default/index");?>"><i class="home_icon"></i><b>首页</b></a></span>
    <span><a href="<?=UrlService::buildMUrl("/product/index");?>"><i class="store_icon"></i><b>线路</b></a></span>
