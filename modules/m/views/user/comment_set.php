...
StaticService::includeAppJsStatic( "/js/m/user/comment_set.js",\app\assets\MAsset::className() );
?>
...
<div class="addr_form_box">
    ...
    <div class="addr_input_box">
        <span>评价内容</span>
        <textarea name="content" rows="2" cols="20" placeholder="请填写本次出行的评价~~" class="addr_textarea"></textarea>
    </div>
</div>
<div class="op_box">
